  ...
  @section('content')
    ...
    <section class="container gx-0 mw-100 ">
        ...
        <div id = "containerHead">
            ...
            {!! Form::textarea( 'newPost', null, ['class' => 'form-control form_layout text_start', 'placeholder' => '投稿内容を入力してください。']) !!}
            <!-- エラー文の表示 -->
            <!-- 上にまとめてエラー文の表示 -->
            ...
            <li class="list-group-item">
                ...
                <div class="table_btn">
                    ...
                    @if ($user->id == $post->user_id)
                        <div class="">
                            <!-- 投稿の編集ボタン -->
                            <a class="js-modal-open" href="/posts/index" post="{{ $post->post }}" post_id="{{ $post->id }}" ><img src="/images/edit.png" alt="投稿編集"></a>
                        </div>
                    @endif
                    <!-- モーダルの中身 -->
                        ...
                        <div>
                            @if ($user->id == $post->user_id)
                                <div class="btn_trash">
                                <!-- 投稿の削除ボタン -->
                                    <a href="/posts/{{ $post->id }}/delete" onclick="showConfirmationModal('この投稿を削除します。よろしいでしょうか?', '/posts/{{ $post->id }}/delete'); return false;">
